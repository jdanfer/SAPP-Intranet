...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Estos son los datos de su perfil de usuario del sistema.'),
        'class' => 'col-lg-7'
    ])
                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name_user">{{ __('Nombre Usuario') }}</label>
                                    <input type="text" name="username" id="input-username" class="form-control form-control-alternative{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre de usuario') }}" value="{{ old('username', auth()->user()->username) }}" required autofocus>
                                ...
                                <div class="form-group {{ $errors->has('sexo') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="sexo">{{ __('Sexo') }}</label>

                                    <select id="sexo" class="form-control input-sm" name="sexo">
